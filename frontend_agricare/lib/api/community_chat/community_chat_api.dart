...
class ChatApiService {
  static String get baseUrl => ApiConfig.chatBase;
  ...
  Future<List<Map<String, dynamic>>> adminGetAllRooms() async {
    try {
      final response = await http.get(
      ...
      throw Exception('Error fetching admin rooms: $e');
    }
  }
  ...
  Future<Map<String, dynamic>> adminGetRoomMembers(String roomId) async {
    try {
      final response = await http.get(
        Uri.parse('$baseUrl/admin/room/$roomId/members'),
        headers: _headers,
      );
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Failed to get admin members: ${response.body}');
      }
    } catch (e) {
      throw Exception('Error fetching admin members: $e');
    }
  }
  ...
  /// Admin: get room messages
  Future<List<Message>> adminGetMessages(String roomId) async {
    try {
      final response = await http.get(
        Uri.parse('$baseUrl/admin/room/$roomId/messages'),
        headers: _headers,
      );
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Failed to load admin messages: ${response.body}');
      }
    } catch (e) {
  ...
  Future<void> adminRemoveMember(String roomId, String memberId) async {
    try {
      final response = await http.delete(
        Uri.parse('$baseUrl/admin/room/$roomId/members/$memberId'),
        headers: _headers,
      );
