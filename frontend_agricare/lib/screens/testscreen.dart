...
import 'package:frontend_agricare/api/auth_service.dart';
import 'package:frontend_agricare/controllers/auth_controller.dart';
import 'package:frontend_agricare/controllers/main_nav_controller.dart';
import 'package:frontend_agricare/routes/app_routes.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildInfoCard(
                    ...
                    value: Obx(
                      () {
                        final label = authController.locationLabel.value.trim();
                        if (label.isNotEmpty) {
                          return Text(
                            label,
                            style: TextStyle(
                      ...
                      Get.dialog(
                        AlertDialog(
                          ...
                          actions: [
                            ...
                            TextButton(
                              onPressed: () async {
                                await authController.clearAllLocalData();
                                Get.back();
