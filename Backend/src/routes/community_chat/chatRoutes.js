...
// Admin moderation (read-only except remove member)
router.get("/admin/rooms", adminGetAllRooms);
router.get("/admin/room/:roomId/messages", adminGetRoomMessages);
router.get("/admin/room/:roomId/members", adminGetRoomMembers);
router.delete("/admin/room/:roomId/members/:memberId", adminRemoveMember);
