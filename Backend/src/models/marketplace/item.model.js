...
// Indexes for common browse filters/sorting
itemSchema.index({ status: 1, isAvailable: 1, isSold: 1, category: 1, subcategory: 1, createdAt: -1 });

// Text search across title/description (weights favor title)
itemSchema.index(
  { title: "text", description: "text" },
  { weights: { title: 5, description: 1 }, default_language: "english" }
);

// Prefix search support (case-insensitive via collation)
itemSchema.index({ title: 1 }, { collation: { locale: "en", strength: 2 } });
